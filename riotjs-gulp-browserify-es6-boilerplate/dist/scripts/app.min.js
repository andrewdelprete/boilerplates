...
exports['default'] = function () {
    ...
    this.on('setCountAction', function (countArray) {
...
this.whipperSnappers = function (value) {
    if (typeof value == 'object') {
        return value.age <= 20;
    }
...
_countArray = function (e) {
    return [{ title: "Old Farts", count: opts.people.filter(_this.oldFarts).length, 'class': 'red' }, { title: "Whippersnappers", count: opts.people.filter(_this.whipperSnappers).length, 'class': 'blue' }, { title: "Total", count: opts.people.length }];
};
