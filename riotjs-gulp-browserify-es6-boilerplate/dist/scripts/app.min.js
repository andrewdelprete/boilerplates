...
exports['default'] = function () {
    ...
    // Store Functions
    var _setCountStore = function _setCountStore(countArray) {
        return _this.trigger('setCountStore', countArray);
    };
...
require('../tags/peoplecount.tag');

var _mixinsPeoplelistObservableJs = require('../mixins/peoplelistObservable.js');

var _mixinsPeoplelistObservableJs2 = _interopRequireDefault(_mixinsPeoplelistObservableJs);

var params = {
    people: [{ name: 'Peter', age: 20 }, { name: 'James', age: 30 }, { name: 'John', age: 40 }, { name: 'Andrew', age: 50 }, { name: 'Judas', age: 61 }]
};

_riot2['default'].mixin('peoplelistObservable', new _mixinsPeoplelistObservableJs2['default']());
_riot2['default'].mount('peoplelist', params);
_riot2['default'].mount('peoplecount');
...
module.exports = riot.tag('peoplecount', '<div each="{ countArray }"><b>{{ title }}</b>: <span class="{ class }">{{ count }}</span></div>', function(opts) {var _this = this;
...
this.add = function (e) {
    ...
    _this.trigger('setCountAction', _countArray());
};
...
_countArray = function (e) {
    return [{
        title: "Old Farts",
        count: opts.people.map(function (person) {
            return person.age;
        }).filter(_this.oldFarts).length,
        'class': 'red'
    }, {
        title: "Whippersnappers",
        count: opts.people.map(function (person) {
            return person.age;
        }).filter(_this.whipperSnappers).length,
        'class': 'blue'
    }, {
        title: "Total",
