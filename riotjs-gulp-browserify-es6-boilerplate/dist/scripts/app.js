...
module.exports = riot.tag('helloworld', '<h1>{ title }</h1> <input id="addInput" onkeyup="{ add }"> <button id="subtractInput" onclick="{ subtract }">Subtract</button> <div>Count: { count }</div>', function(opts) {var _this = this;
