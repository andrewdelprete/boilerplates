...
_riot2['default'].mount('helloworld');

},{"../tags/helloworld.tag":3,"riot":1}],3:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag('helloworld', '<h1>{ title }</h1> <input id="addInput" onkeyup="{ add }"> <button id="subtractButton" onclick="{ subtract }">Subtract</button> <button id="clearButton" onclick="{ clear }">Clear</button> <div>Count: { count }</div> <div>Double: <double number="{ count }"></double></div>', function(opts) {var _this = this;
